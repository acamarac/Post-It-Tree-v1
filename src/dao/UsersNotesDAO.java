...
public interface UsersNotesDAO {
	...
	/**
	 * Deletes all userNotes with that idn from the database.
	 *            
	 * @param idn
	 *            Note Identifier
	 * 
	...
	/**
	 * Return the id of the user who owns this note
	 *            
	 * @param idn
	 *            Note Identifier
	 * 
	 * @return idu of the user owner if the operation was made and -1 if it failed.
	 */
